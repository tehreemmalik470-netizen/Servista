export const servicesData = {
  "cleaningservices": {
    ...
    items: [
      { id: 1, name: "Sofa Cleaning", price: 500, img: "/sofa cleaning.jpg",description: "- Price Per Seat x 500"},
      { id: 2, name: "Water Tank Cleaning", price: 3000, img: "/water tank cleaning.jpg",description:"- Price Per water tank x 3000"},
      { id: 3, name: "Carpet Cleaning", price:500, img: "/carpet cleaning.jpg" },
      { id: 4, name: "curtain cleaning", price: 800, img: "/curtain cleaning.jpg",description: "- Price Per curtain" },
      { id: 5, name: "Mattress", price: 1000, img: "/mattress cleaning.jpg" },
    { id: 6, name: "Solar cleaning", price: 700, img: "/solar cleaning.jpg",description: "- Price Per Solar plate x 700" }
    ]
  },
  "electrician": {
    ...
    items: [
      ...
      { id: 9, name: " smart Switch Board installation", price: 500, img: "/smart switch board.jpg",description: "- Price Per Switch board x 500" },
      { id: 10, name: " Electric Motor repairing", price: 2000, img: "/electric motor.jpg" }, 
    { id: 11, name: "Transformer repairing", price: 2000, img: "/transformer.jpg" },
    { id: 12, name: "Electric lights plugin wiring", price: 2000, img: "/electric light pluginwire.jpg" },
    { id: 13, name: "UPS wiring", price: 4000, img: "/ups.jpg" }
    ]
  },
  "carpenterservices": {
    title: "Carpentor services ",
    items: [
      { id: 14, name: "Drawer repairing", price: 800, img: "/drawer repairing.jpg",description: "- Price Per Draw x 800" },
      { id: 15, name: "Door lock repairing/installation ", price: 800, img: "/door lock repairing.jpg",description: "- Price Per door loc x 800, min count 5" },
      { id: 16, name: "bed repaire", price: 500, img: "/bed repaire.jpg" },
      { id: 17, name: "kitchen cabnet", price: 1000, img: "/kitchen cabnet.jpg",description: "- Price Per cabnet x 1000" },
      { id:18, name: "wardrobe", price: 20000, img: "/wardrobe.jpg" }
    ]
  },
  "painting&decor": {
